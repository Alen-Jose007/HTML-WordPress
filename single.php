        ...
        <div class="row tm-row">
            <div class="col-12">
                ...
                <video width="954" height="535" controls class="tm-mb-40">
                    <source src="<?php bloginfo('template_directory'); ?>/video/wheat-field.mp4" type="video/mp4">
            ...
            <aside class="col-lg-4 tm-aside-col">
                <div class="tm-post-sidebar">
                    ...
                    <a href="#" class="d-block tm-mb-40">
                        <figure>
                            <img src="<?php bloginfo('template_directory'); ?>/img/img-02.jpg" alt="Image" class="mb-3 img-fluid">
                            <figcaption class="tm-color-primary">Duis mollis diam nec ex viverra scelerisque a sit</figcaption>
                        </figure>
                    </a>
                    <a href="#" class="d-block tm-mb-40">
                        <figure>
                            <img src="<?php bloginfo('template_directory'); ?>/img/img-05.jpg" alt="Image" class="mb-3 img-fluid">
                            <figcaption class="tm-color-primary">Integer quis lectus eget justo ullamcorper ullamcorper</figcaption>
                        </figure>
                    </a>
                    <a href="#" class="d-block tm-mb-40">
                        <figure>
                            <img src="<?php bloginfo('template_directory'); ?>/img/img-06.jpg" alt="Image" class="mb-3 img-fluid">
